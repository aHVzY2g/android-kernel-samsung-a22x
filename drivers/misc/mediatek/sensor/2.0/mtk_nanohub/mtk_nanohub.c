...
struct mtk_nanohub_device {
    ...
    //Req641697,jiaoyuxin.wt,modify,20210331,distinguish mag-parameters according to nfc supported or not
	int32_t mag_config_data[10];
    //bug627250,jiaoyuxin.wt,modify,20210403,distinguish als-parameters according to lcd type
		...
		int sensor_type, int32_t *data)
{
	...
	case ID_LIGHT:
		...
		spin_unlock(&config_data_lock);
        //bug627250,jiaoyuxin.wt,add,20210403,distinguish als-parameters according to lcd type
