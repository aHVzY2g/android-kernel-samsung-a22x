...
#include "w1hi4821qrearqt_mipiraw_Sensor.h"


#define PFX "w1hi4821qrearqt_camera_sensor"
#define LOG_INF(format, args...)    \
	pr_info(PFX "[%s] " format, __func__, ##args)
#define LOG_DBG(format, args...)    \
	pr_debug(PFX "[%s] " format, __func__, ##args)

//+bug604664 zhouyikuan, add, 2020/12/18,w1hi4821qrearqt_qt eeprom bring up
#define W1HI4821QREARQT_OTP_ENABLE 1

#if W1HI4821QREARQT_OTP_ENABLE
//+bug550253 chenbocheng.wt, modify, 2020/11/16,the w1hi4821qrearqt otp porting
...
//bool hi4821q_is_seamless;
kal_uint16 hi4821q_i2c_data [_I2C_BUF_SIZE];
//unsigned int hi4821q_size_to_write;
//-bug604664 chenbocheng.wt, add, 2021/02/27, add hi4821q seamless code

static kal_uint16 w1hi4821qrearqt_read_eeprom(kal_uint32 addr)
{
...
#define W1HI4821QREARQT_XGC_QGC_BPGC_CALIB 1

#define W1HI4821QREARQT_OTP_DUMP 0

#if W1HI4821QREARQT_XGC_QGC_BPGC_CALIB
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = W1HI4821QREARQT_SENSOR_ID,
...
#include "w1hi4821qrearqt_mipiraw_Sensor_lamei.h"
...
static kal_uint16 w1hi4821qrearqt_table_write_cmos_sensor(
...
static void apply_sensor_XGC_QGC_Cali(void)
{
	...
	//XGC data apply
	{
		...
		if(length1 == (XGC_DATA_SIZE/2)){
			w1hi4821qrearqt_table_write_cmos_sensor(
...
static void apply_sensor_BPGC_Cali(void)
{
	...
	//BPGC data apply
	{
		...
		#if W1HI4821QREARQT_OTP_DUMP
			LOG_INF("sensor_bpgc_addr:0x%x,bpgc_data_buffer[%d]:0x%x,bpgc_data_buffer[%d]:0x%x,hi4821_bpgc_data:0x%x\n",
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_w1hi4821qrearqt[] = {
	0x0790, 0x0100,
	0x9000, 0x706F,
	0x9002, 0x0000,
	0x9004, 0x67B1,
...
static void sensor_init(void)
{
	...
	if (true == board_is_lamei){
	 	w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_init_w1hi4821qrearqt_lamei,
			sizeof(addr_data_pair_init_w1hi4821qrearqt_lamei) /
			sizeof(kal_uint16));
	} else {
	 	w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_init_w1hi4821qrearqt,
			sizeof(addr_data_pair_init_w1hi4821qrearqt) /
		sizeof(kal_uint16));
	}
	//-Bug 604664 zhanghao2, add, 2021/08/04/, distinguish 801BA1 version to use 865Mhz mipi clock.
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_w1hi4821qrearqt[] = {
	0x0208, 0x0100,
	0xC3B0, 0x4408,
	0xC3B2, 0x0386,
	0xC3B4, 0x0046,
...
static void preview_setting(void)
{
	...
	if (true == board_is_lamei){
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_preview_w1hi4821qrearqt_lamei,
			sizeof(addr_data_pair_preview_w1hi4821qrearqt_lamei) /
			sizeof(kal_uint16));
	} else {
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_preview_w1hi4821qrearqt,
			sizeof(addr_data_pair_preview_w1hi4821qrearqt) /
			sizeof(kal_uint16));
	}
	//-Bug 604664 zhanghao2, add, 2021/08/04/, distinguish 801BA1 version to use 865Mhz mipi clock.
}
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_30fps_w1hi4821qrearqt[] = {
	0x0208, 0x0100,
	0xC3B0, 0x4408,
	0xC3B2, 0x0386,
	0xC3B4, 0x0046,
...
kal_uint16 addr_data_pair_capture_15fps_w1hi4821qrearqt[] = {
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (true == board_is_lamei){
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_w1hi4821qrearqt_lamei,
			sizeof(addr_data_pair_capture_30fps_w1hi4821qrearqt_lamei) /
			sizeof(kal_uint16));
	} else {
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_w1hi4821qrearqt,
			sizeof(addr_data_pair_capture_30fps_w1hi4821qrearqt) /
			sizeof(kal_uint16));
	}
	//-Bug 604664 zhanghao2, add, 2021/08/04/, distinguish 801BA1 version to use 865Mhz mipi clock.
}
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_w1hi4821qrearqt[] = {
	0x0208, 0x0100,
	0xC3B0, 0x4408,
	0xC3B2, 0x0386,
	0xC3B4, 0x0046,
...
static void video_setting(void)
{
	...
	if (true == board_is_lamei){
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_video_w1hi4821qrearqt_lamei,
			sizeof(addr_data_pair_video_w1hi4821qrearqt_lamei) /
			sizeof(kal_uint16));
	} else {
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_video_w1hi4821qrearqt,
			sizeof(addr_data_pair_video_w1hi4821qrearqt) /
			sizeof(kal_uint16));
	}
	//-Bug 604664 zhanghao2, add, 2021/08/04/, distinguish 801BA1 version to use 865Mhz mipi clock.
}
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_w1hi4821qrearqt[] = {
	0x0208, 0x0100,
	0xC3B0, 0x0508,
	0xC3B2, 0x02E9,
	0xC3B4, 0x0042,
...
static void hs_video_setting(void)
{
	...
	if (true == board_is_lamei){
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_hs_video_w1hi4821qrearqt_lamei,
			sizeof(addr_data_pair_hs_video_w1hi4821qrearqt_lamei) /
			sizeof(kal_uint16));
	} else {
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_hs_video_w1hi4821qrearqt,
			sizeof(addr_data_pair_hs_video_w1hi4821qrearqt) /
			sizeof(kal_uint16));
	}
	//-Bug 604664 zhanghao2, add, 2021/08/04/, distinguish 801BA1 version to use 865Mhz mipi clock.
}
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_w1hi4821qrearqt[] = {
	0x0208, 0x0100,
	0xC3B0, 0x0508,
	0xC3B2, 0x02E9,
	0xC3B4, 0x0042,
...
static void slim_video_setting(void)
{
	...
	if (true == board_is_lamei){
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_slim_video_w1hi4821qrearqt_lamei,
			sizeof(addr_data_pair_slim_video_w1hi4821qrearqt_lamei) /
			sizeof(kal_uint16));
	} else {
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_slim_video_w1hi4821qrearqt,
			sizeof(addr_data_pair_slim_video_w1hi4821qrearqt) /
			sizeof(kal_uint16));
	}
	//-Bug 604664 zhanghao2, add, 2021/08/04/, distinguish 801BA1 version to use 865Mhz mipi clock.
}
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_w1hi4821qrearqt[] = {
	0x0208, 0x0100,
	0xC3B0, 0x4408,
	0xC3B2, 0x0386,
	0xC3B4, 0x0046,
...
static void custom1_setting(void)
{
	...
	if (true == board_is_lamei){
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_custom1_w1hi4821qrearqt_lamei,
			sizeof(addr_data_pair_custom1_w1hi4821qrearqt_lamei) /
			sizeof(kal_uint16));
	} else {
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_custom1_w1hi4821qrearqt,
			sizeof(addr_data_pair_custom1_w1hi4821qrearqt) /
			sizeof(kal_uint16));
	}
	//-Bug 604664 zhanghao2, add, 2021/08/04/, distinguish 801BA1 version to use 865Mhz mipi clock.
}
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom2_w1hi4821qrearqt[] = {
	0x0208, 0x0100,
	0xC3B0, 0x4008,
	0xC3B2, 0x0386,
	0xC3B4, 0x004B,
...
static void custom2_setting(void)
{
	...
	if (true == board_is_lamei){
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_custom2_w1hi4821qrearqt_lamei,
			sizeof(addr_data_pair_custom2_w1hi4821qrearqt_lamei) /
			sizeof(kal_uint16));
	} else {
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_custom2_w1hi4821qrearqt,
			sizeof(addr_data_pair_custom2_w1hi4821qrearqt) /
			sizeof(kal_uint16));
	}
	//-Bug 604664 zhanghao2, add, 2021/08/04/, distinguish 801BA1 version to use 865Mhz mipi clock.
}
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom3_w1hi4821qrearqt[] = {
	0x0208, 0x0100,
	0xC3B0, 0x4008,
	0xC3B2, 0x06D8,
	0xC3B4, 0x004B,
...
static void custom3_setting(void)
{
	...
	if (true == board_is_lamei){
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_custom3_w1hi4821qrearqt_lamei,
			sizeof(addr_data_pair_custom3_w1hi4821qrearqt_lamei) /
			sizeof(kal_uint16));
	} else {
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_custom3_w1hi4821qrearqt,
			sizeof(addr_data_pair_custom3_w1hi4821qrearqt) /
			sizeof(kal_uint16));
	}
	//-Bug 604664 zhanghao2, add, 2021/08/04/, distinguish 801BA1 version to use 865Mhz mipi clock.
...
kal_uint16 addr_data_pair_custom4_w1hi4821qrearqt[] = {
	0x0208, 0x0100,
	0xC3B0, 0x0908,
	0xC3B2, 0x02E9,
	0xC3B4, 0x0042,
...
static void custom4_setting(void)
{
	...
	if (true == board_is_lamei){
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_custom4_w1hi4821qrearqt_lamei,
			sizeof(addr_data_pair_custom4_w1hi4821qrearqt_lamei) /
			sizeof(kal_uint16));
	} else {
		w1hi4821qrearqt_table_write_cmos_sensor(
			addr_data_pair_custom4_w1hi4821qrearqt,
			sizeof(addr_data_pair_custom4_w1hi4821qrearqt) /
			sizeof(kal_uint16));
	}
	//-Bug 604664 zhanghao2, add, 2021/08/04/, distinguish 801BA1 version to use 865Mhz mipi clock.
...
#if W1HI4821QREARQT_OTP_ENABLE
//+bug584789 chenbocheng.wt, add, 2020/11/16, add main camera w1hi4821qrearqt otp code
#include "cam_cal_define.h"
#include <linux/slab.h>
//+bug604664 zhouyikuan, add, 2020/12/18,w1hi4821qrearqt_qt eeprom bring up
static struct stCAM_CAL_DATAINFO_STRUCT st_rear_w1hi4821qrearqt_eeprom_data ={
	.sensorID= W1HI4821QREARQT_SENSOR_ID,
	.deviceID = 0x01,
	.dataLength = 0x1638,
...
static struct stCAM_CAL_CHECKSUM_STRUCT st_rear_w1hi4821qrearqt_Checksum[11] =
{
...
#if W1HI4821QREARQT_OTP_ENABLE
			//+bug584789 chenbocheng.wt, add, 2020/11/16, add main camera w1hi4821qrearqt otp code
			size = imgSensorReadEepromData(&st_rear_w1hi4821qrearqt_eeprom_data,st_rear_w1hi4821qrearqt_Checksum);
			if(size != st_rear_w1hi4821qrearqt_eeprom_data.dataLength || (st_rear_w1hi4821qrearqt_eeprom_data.sensorVendorid >> 24)!= w1hi4821qrearqt_read_eeprom(0x0001)) {
				pr_err("get eeprom data failed\n");
				if(st_rear_w1hi4821qrearqt_eeprom_data.dataBuffer != NULL) {
					kfree(st_rear_w1hi4821qrearqt_eeprom_data.dataBuffer);
					st_rear_w1hi4821qrearqt_eeprom_data.dataBuffer = NULL;
				}
				*sensor_id = 0xFFFFFFFF;
				return ERROR_SENSOR_CONNECT_FAIL;
			} else {
				pr_info("get eeprom data success\n");
				imgSensorSetEepromData(&st_rear_w1hi4821qrearqt_eeprom_data);

				#if W1HI4821QREARQT_XGC_QGC_BPGC_CALIB
					//get the xgc qgc bpgc buffer
					xgc_data_buffer = &(st_rear_w1hi4821qrearqt_eeprom_data.dataBuffer[st_rear_w1hi4821qrearqt_Checksum[HI4821Q_XGC - 1].startAdress + 1]);
					qgc_data_buffer = &(st_rear_w1hi4821qrearqt_eeprom_data.dataBuffer[st_rear_w1hi4821qrearqt_Checksum[HI4821Q_QGC - 1].startAdress + 1]);
					bpgc_data_buffer = &(st_rear_w1hi4821qrearqt_eeprom_data.dataBuffer[st_rear_w1hi4821qrearqt_Checksum[HI4821Q_BPGC - 1].startAdress + 1]);


					#if W1HI4821QREARQT_OTP_DUMP
						pr_info("w1hi4821qrearqt_eeprom:xgc_addr:0x%x\n",st_rear_w1hi4821qrearqt_Checksum[HI4821Q_XGC - 1].startAdress + 1);
						pr_info("w1hi4821qrearqt_eeprom:qgc_addr:0x%x\n",st_rear_w1hi4821qrearqt_Checksum[HI4821Q_QGC - 1].startAdress + 1);
						pr_info("w1hi4821qrearqt_eeprom:bpgc_addr:0x%x\n",st_rear_w1hi4821qrearqt_Checksum[HI4821Q_BPGC - 1].startAdress + 1);

						pr_info("=====================w1hi4821qrearqt dump xgc eeprom data start====================\n");
						dumpEEPROMData(XGC_DATA_SIZE,xgc_data_buffer);
						pr_info("=====================w1hi4821qrearqt dump xgc eeprom data end======================\n");

						pr_info("=====================w1hi4821qrearqt dump qgc eeprom data start====================\n");
						dumpEEPROMData(QGC_DATA_SIZE,qgc_data_buffer);
						pr_info("=====================w1hi4821qrearqt dump qgc eeprom data end======================\n");

						pr_info("=====================w1hi4821qrearqt dump bpgc eeprom data start====================\n");
						dumpEEPROMData(BPGC_DATA_SIZE,bpgc_data_buffer);
						pr_info("=====================w1hi4821qrearqt dump bpgc eeprom data end======================\n");
					#endif
				#endif
			}
			//-bug584789 chenbocheng.wt, add, 2020/11/16, add main camera w1hi4821qrearqt otp code
     ...
     kal_uint32 shutter_2ndframe, kal_uint32 gain_2ndframe)
{
	...
	//_is_seamless = true;
	memset(hi4821q_i2c_data, 0x0, sizeof(hi4821q_i2c_data));
	//hi4821q_size_to_write = 0;

	LOG_INF("seamless_switch %d, %d, %d, %d, %d, sizeof(hi4821q_i2c_data) %d\n",scenario_id, shutter, gain, shutter_2ndframe, gain_2ndframe,sizeof(hi4821q_i2c_data));
...
UINT32 W1HI4821QREARQT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
}	/*	w1hi4821qrearqt_MIPI_RAW_SensorInit	*/
