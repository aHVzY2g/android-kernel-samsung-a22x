...
UINT32 W1OV48B2QREARXL_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//-bug584789,liudijin.wt,ADD,2020/12/12,add 3 gong xinli ov48b2q bringup code.

//+bug584789, qinduilin.wt,ADD,2021/02/20,add for OV64B40 bringup
UINT32 W1OV64B40REARTXD_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//-bug584789, qinduilin.wt,ADD,2021/02/20,add for OV64B40 bringup

//+bug584789,zhouyikuan.wt,MODIFY,2020/12/04,n22_st_hi846 n22_dc_gc8034 camera sensor bringup
...
UINT32 W1_C2515_DEP_CXT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 W1_BF2253_DEP_LH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//+bug604664 chenbocheng.wt, add, 2021/01/13, distinguish depth camera params for dualcam
UINT32 W1BF2253DEPLH3_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 W1_GC02M1B_DEP_CXT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 W1GC02M1BDEPCXT5_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//-bug604664 chenbocheng.wt, add, 2021/01/13, distinguish depth camera params for dualcam
//-bug584789,zhanghengyuan.wt,MODIFY,2020/12/17,depth c2515 bf2253 gc02m1b bringup

//+bug604664 liudijin.wt, add, 2021/04/16, distinguish depth camera params for ov64b40 dualcam
UINT32 W1BF2253DEPLH64_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 W1C2515DEPSJ64_MIPI_MONO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//-bug604664 liudijin.wt, add, 2021/04/16, distinguish depth camera params for ov64b40 dualcam
#if 0
/*IMX*/
...
UINT32 W1HI556WIDEXL_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 W1GC5035CWIDECXT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//-bug584789, liuxingyu.wt, ADD, 2020/12/13, add hi556 gc5035c bringup
//+bug584789, liudijin.wt, ADD, 2021/01/11, add 3 gong wide camera sc500cs bringup
UINT32 W1SC500CSWIDELY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//-bug584789, liudijin.wt, ADD, 2021/01/11, add 3 gong wide camera sc500cs bringup
