...
#include "w1gc8034frontdc_mipi_Sensor.h"
...
//+bug604664 zhouyikuan, add, 2020/12/14,gc8034 eeprom bring up
#define EEPROM_GT24P64E_ID 0xA0

static kal_uint16 read_n22_gc8034_eeprom(kal_uint32 addr)
{
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = W1GC8034FRONTDC_SENSOR_ID,
    ...
    .min_gain_iso = 100,
    .gain_step = 1,
    .gain_type = 4,    //bug 646787 zhanghao2, add, 2021/04/25,fix ITS:cam1 scense1_1 test exposure fail
...
//+bug596770 zhouyikuan.wt, modify, 2020/12/17,add DD data bad pixel correction
...
static void gain2reg(kal_uint16 gain)
{
    ...
    /*kal_uint8 i = 0;*/
    //+bug 646787 zhanghao2, add, 2021/04/25,fix ITS:cam1 scense1_1 test exposure fail
...
static void slim_video_setting(void)
{
    ...
    write_cmos_sensor(0x94, 0xb0 + GC8034_BIN_STARTX);
...
static struct stCAM_CAL_DATAINFO_STRUCT w1gc8034frontdc_eeprom_data ={
    .sensorID= W1GC8034FRONTDC_SENSOR_ID,
    .deviceID = 0x02,
    .dataLength = 0x76A,
...
static struct stCAM_CAL_CHECKSUM_STRUCT w1gc8034frontdc_checksum[8] =
{
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                pr_info("[gc8034_camera_sensor]get_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
                    imgsensor.i2c_write_id, *sensor_id);
                //+bug604664 zhouyikuan, add, 2020/12/14,gc8034  eeprom bring up
                size = imgSensorReadEepromData(&w1gc8034frontdc_eeprom_data,w1gc8034frontdc_checksum);
                if(size != w1gc8034frontdc_eeprom_data.dataLength || (w1gc8034frontdc_eeprom_data.sensorVendorid >> 24)!= read_n22_gc8034_eeprom(0x0001)) {
                    pr_err("get eeprom data failed\n");
                    if(w1gc8034frontdc_eeprom_data.dataBuffer != NULL) {
                        kfree(w1gc8034frontdc_eeprom_data.dataBuffer);
                        w1gc8034frontdc_eeprom_data.dataBuffer = NULL;
                    }
                    //*sensor_id = 0xFFFFFFFF;
                    //return ERROR_SENSOR_CONNECT_FAIL;
                } else {
                    pr_debug("get eeprom data success\n");
                    imgSensorSetEepromData(&w1gc8034frontdc_eeprom_data);
                }
                //-bug604664 zhouyikuan, add, 2020/12/14,hi846&gc8034  eeprom bring up
                return ERROR_NONE;
            }
            pr_err("[gc8034_camera_sensor]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
                imgsensor.i2c_write_id, *sensor_id);
            retry--;
        } while (retry > 0);
        i++;
...
static kal_uint32 open(void)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            sensor_id = return_sensor_id();
            if (sensor_id == imgsensor_info.sensor_id) {
                pr_info("[gc8034_camera_sensor]open:i2c write id: 0x%x, sensor id: 0x%x\n",
                    imgsensor.i2c_write_id, sensor_id);
                break;
            }
            pr_info("[gc8034_camera_sensor]open:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
                imgsensor.i2c_write_id, sensor_id);
            retry--;
        } while (retry > 0);
        i++;
		...
		*feature_para_len = 4;
        ...
        case SENSOR_FEATURE_GET_FRAME_CTRL_INFO_BY_SCENARIO:
                ...
                *(feature_data + 2) = imgsensor_info.margin;
                break;
    //+bug 646787 zhanghao2, add, 2021/04/25,fix ITS:cam1 test_sensor_fusion fail
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
            *(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 11475000;
        break;
    //-bug 646787 zhanghao2, add, 2021/04/25,fix ITS:cam1 test_sensor_fusion fail
...
UINT32 W1GC8034FRONTDC_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
