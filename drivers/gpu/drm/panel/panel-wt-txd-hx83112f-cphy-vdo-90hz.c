...
static void txd_panel_init(struct txd *ctx)
{
	...
	txd_dcs_write_seq_static(ctx, 0xD8, 0xAA, 0xAA, 0xAF, 0xEA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAF,
			...
			0xEA, 0xAB, 0xFF);
	txd_dcs_write_seq_static(ctx, 0xBD, 0x00);
	txd_dcs_write_seq_static(ctx, 0xE7, 0x47, 0x29, 0x0C, 0x0C, 0x21, 0x87, 0x2B, 0x87, 0x2A,
			0x87, 0x04, 0x02);
	txd_dcs_write_seq_static(ctx, 0xE9, 0xDC);
	txd_dcs_write_seq_static(ctx, 0xE7, 0x48, 0x17, 0x03);
	txd_dcs_write_seq_static(ctx, 0xE9, 0x3F);
	txd_dcs_write_seq_static(ctx, 0xBD, 0x01);
	txd_dcs_write_seq_static(ctx, 0xE7, 0x02, 0x50, 0xDC, 0x01, 0x3C, 0x07, 0x2C, 0x0C);
	txd_dcs_write_seq_static(ctx, 0xBD, 0x02);
	...
	txd_dcs_write_seq_static(ctx, 0xBD, 0x00);
	txd_dcs_write_seq_static(ctx, 0x51, 0x0f, 0xf0);
	txd_dcs_write_seq_static(ctx, 0x53, 0x24);
		...
		unsigned int level)
{
	...
	pr_info("%s backlight = -%d, bl_tb0[1] = %x %x\n", __func__, level, bl_tb0[1], bl_tb0[2]);
