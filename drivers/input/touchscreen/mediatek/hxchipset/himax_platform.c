...
static struct pinctrl *himax_spi_pinctrl;
static struct pinctrl_state *spi_all;
...
static int hx_panel_coords[4] = {0, 1080, 0, 2408};
static int hx_display_coords[4] = {0, 1080, 0, 2408};
